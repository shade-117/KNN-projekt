            ...
            nn.Sequential(
                ...
                nn.Sequential(Map(lambda x: x,  # ConcatTable,
                                  nn.Sequential(
                                      ...
                                      nn.UpsamplingNearest2d(scale_factor=2)), nn.Sequential(
                        Reduce(lambda x, y, dim=1: torch.cat((x, y), dim),  # Concat,
                               nn.Sequential(
                                   *conv1(128, 32)), nn.Sequential(
                                *conv1(128, 32), *conv3(32, 32)), nn.Sequential(
                                *conv1(128, 32), *conv5(32, 32)), nn.Sequential(
                                *conv1(128, 32), *conv7(32, 32))),
                        Reduce(lambda x, y, dim=1: torch.cat((x, y), dim),  # Concat,
                               nn.Sequential(*conv1(128, 32)),
